...
<div in:fade={{ duration: 800 }} class="sticky top-0 z-10 border-b border-border-subtle flex flex-col sm:flex-row sm:items-start justify-between gap-6 mb-4 py-3">
	<header>
